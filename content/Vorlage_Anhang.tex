...
\begin{\tabletype}[H]{|p{.12\linewidth}|p{.83\linewidth}|}
    ...
    \endhead
    4.1-2.3.1 & Existing  devices MAY continue to use the existing JTAG or JEDEC
    manufacturer ID \\ \hline
    4.1-2.3.2 & New  JEDEC devices (released after August 1, 2014) MUST use the  JEDEC
    manufacturer ID \\ \hline
